...
urlpatterns = [
    ...
    path('profile/updateprofile/<int:pk>/',
         views.UpdateProfile.as_view(), name="update_profile"),

    path('career/', views.CareerCreateView.as_view(), name='career'),
    path('career/update-experience/<int:pk>/',
         views.UpdateExperice.as_view(), name="update_experience"),
    path('career/delete-experience/<int:pk>/',
         views.destroyBatch, name="delete_experience"),
